...
3. **arm64-v8a + Vulkan only.** Do not add armeabi-v7a, x86 targets (except the optional x86_64 emulator build), a GLES render path, or any Cg. If you find Cg-dependent code, porting it away is the task — routing around it is not.
